 ...
 * @author maxi
 */
public class TLFETLCard extends Configured implements Tool {
    ...
    public int run(String[] strings) throws Exception {
        ...
        job.setJarByClass(TLFETLCard.class);
        ...
        job.setMapperClass(TLFETLCardMapper.class);
        job.setReducerClass(TLFETLCardReducer.class);
    ...
    public static void main(String[] args) throws Exception {
        int exitCode = ToolRunner.run(new TLFETLCard(), args);
